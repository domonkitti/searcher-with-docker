      ...
      <div className="card">
        ...
        {doc && (
          <>
            ...
            {!!emergency.trim() && <div className="small" style={{ marginTop: 6, whiteSpace: "pre-wrap" }}><b>อำนาจอนุมัติ:</b><br /> {emergency}</div>}
            ...
            {!!special.trim() && <div className="small" style={{ marginTop: 6, whiteSpace: "pre-wrap" }}><b>หมายเหตุ:</b><br /> {special}</div>}
            {links.length > 0 && (
