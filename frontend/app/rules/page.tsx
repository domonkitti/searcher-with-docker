        ...
        <div className="card" style={{ marginTop: 12 }}>
          ...
          */}
          ...
          <div className="small" style={{ marginTop: 12 }}>
            หากไม่พบรายการที่ตรงกับของที่ค้นให้ใช้ราคาและอายุการใช้งานในการประเมินโดย
            <br />- เฉพาะกรณี ราคาเกิน 10,000 บาท ต่อ ชิ้น และ อายุการใช้งานเกิน 1 ปี ให้จัดเป็น
            <span style={{ color: "blue" }}>งบลงทุน</span>
